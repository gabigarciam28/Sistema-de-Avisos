...
namespace WebServiceAltamira.Controllers
{
    public class AvisosController : ApiController
    {
        ...
        public async Task<string> CreateAvisos(AvisosModel model)
        {
            ...
            model1.Duracion = DateTime.Now.AddDays(1); //Duración en días del aviso correspondiente
            model1.Mensaje = "Demo Aviso";
            model1.Nombre = "Demo Aviso";
            model1.IsCodigo = true; //Por si queremos que se visualice el HTML a la hora de enviar el aviso.
